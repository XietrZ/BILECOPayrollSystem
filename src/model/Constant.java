...
public class Constant {
	...
	public final static String PAYROLL_SYSTEM_VERSION="version 1.8",
	...
	public final static int PAYSLIP_PDF=1, PAYROLL_PER_DEPARTMENT_PDF=2, PAYROLL_OVERALL_PDF=3,
			...
			PAYROLL_CITY_SAVINGS_PDF=8,PAYROLL_SSS_LOAN_PDF=9,PAYROLL_PAGIBIG_LOAN_PDF=10,PAYROLL_ST_PETER_PLAN_PDF=11,
	...
	public final static int  PAYROLL_PER_DEPARTMENT_EXCEL=22, PAYROLL_OVERALL_EXCEL=23,
			...
			PAYROLL_CITYSAVINGS_EXCEL=28,PAYROLL_SSS_LOAN_EXCEL=29,PAYROLL_PAGIBIG_LOAN_EXCEL=210,PAYROLL_ST_PETER_PLAN_EXCEL=211,
	...
	public final static int 
		...
		RETRIEVE_PREV_VAL_SAL_ADJ_VALUE=99,
		RETRIEVE_PREV_VAL_NS_DIFF_VALUE=011,
		RETRIEVE_PREV_VAL_RATA_VALUE=022,
		RETRIEVE_PREV_VAL_LWPAY_VALUE=033
		;
	...
	public final static int 
		...
		RETRIEVE_PREV_VAL_SSS_LOAN_VALUE=7777,
		RETRIEVE_PREV_VAL_PAGIBIG_LOAN_VALUE=8888,
		RETRIEVE_PREV_VAL_MP2_VALUE=9999,
		RETRIEVE_PREV_VAL_MAID_VALUE=01111,
		RETRIEVE_PREV_VAL_BEMCO_VALUE=02222,
		RETRIEVE_PREV_VAL_LBP_VALUE=03333,
		RETRIEVE_PREV_VAL_EMLOAN_VALUE=04444,
		RETRIEVE_PREV_VAL_AR_VALUE=05555,
		RETRIEVE_PREV_VAL_WTAX_VALUE=06666
		;
	...
	public final static int 
		...
		SAL_ADJ_COLUMN_INDEX=1,
		NS_DIFF_COLUMN_INDEX=3,
		RATA_COLUMN_INDEX=5,
		LW_PAY_COLUMN_INDEX=9,
	...
	public final static int 
		...
		SSS_LOAN_COLUMN_INDEX=0,
		PAGIBIG_LOAN_COLUMN_INDEX=1,
		MP2_COLUMN_INDEX=5,
		MAID_COLUMN_INDEX=6,
		BEMCO_COLUMN_INDEX=7,
		LBP_COLUMN_INDEX=9,
		EMLOAN_COLUMN_INDEX=10,
		AR_COLUMN_INDEX=11,
		WTAX_COLUMN_INDEX=12
	;
	...
	public final static String
		...
		DISPLAY_CITY_SAVINGS_DATA_PDF="Display City Savings Data Pdf",DISPLAY_SSS_LOAN_DATA_PDF="Display SSS Loan Data Pdf",
		...
		EXPORT_CITY_SAVINGS_DATA_EXCEL ="EXPORT City Savings Data EXCEL ",EXPORT_SSS_LOAN_DATA_EXCEL ="EXPORT SSS Loan Data EXCEL",
